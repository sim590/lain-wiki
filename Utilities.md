...
* Set `followtag = true` if [experiencing issue with multiscreen setups](https://github.com/copycat-killer/lain/issues/346).
...
* If you are using `gnome-terminal`, you may also need to add `extra = "--disable-factory"` option. This fixes gnome-terminal's unwanted existing-windows-reusing behavior.
